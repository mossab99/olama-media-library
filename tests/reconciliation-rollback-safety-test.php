...
assert_rollback_safety(strpos($plugin, "OLAMA_MEDIA_LIBRARY_VERSION', '2.6.1'") !== false, 'Plugin version must be 2.6.1.');
assert_rollback_safety(strpos($plugin, "OLAMA_MEDIA_LIBRARY_DB_VERSION', '2.6.0'") !== false, 'Database version must trigger rollback audit columns.');
