...
assert_rollback_safety(strpos($plugin, "OLAMA_MEDIA_LIBRARY_VERSION', '2.11.0'") !== false, 'Plugin version must be 2.11.0.');
assert_rollback_safety(strpos($plugin, "OLAMA_MEDIA_LIBRARY_DB_VERSION', '2.9.0'") !== false, 'Database version must include rollback audit columns.');
