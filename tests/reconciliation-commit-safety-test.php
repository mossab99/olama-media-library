...
assert_commit_safety(strpos($plugin, "OLAMA_MEDIA_LIBRARY_VERSION', '2.7.0'") !== false, 'Plugin version must be 2.7.0.');
assert_commit_safety(strpos($plugin, "OLAMA_MEDIA_LIBRARY_DB_VERSION', '2.7.0'") !== false, 'Database version must include all reconciliation and folder-plan migrations.');
