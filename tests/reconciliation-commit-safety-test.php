...
assert_commit_safety(strpos($plugin, "OLAMA_MEDIA_LIBRARY_VERSION', '2.7.1'") !== false, 'Plugin version must be 2.7.1.');
assert_commit_safety(strpos($plugin, "OLAMA_MEDIA_LIBRARY_DB_VERSION', '2.7.1'") !== false, 'Database version must include all reconciliation and folder-plan migrations.');
