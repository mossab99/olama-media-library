...
class Olama_Media_DB
{
    ...
    public function create_tables()
    {
        ...
        dbDelta("CREATE TABLE {$folder_plans} (
            ...
            rename_count INT UNSIGNED NOT NULL DEFAULT 0,
            conflict_count INT UNSIGNED NOT NULL DEFAULT 0,
            blocked_count INT UNSIGNED NOT NULL DEFAULT 0,
            apply_run_uuid VARCHAR(100) NULL,
            applied_created_count INT UNSIGNED NOT NULL DEFAULT 0,
            applied_reused_count INT UNSIGNED NOT NULL DEFAULT 0,
            applied_renamed_count INT UNSIGNED NOT NULL DEFAULT 0,
            apply_error TEXT NULL,
            apply_started_at DATETIME NULL,
            apply_finished_at DATETIME NULL,
        ...
        dbDelta("CREATE TABLE {$folder_plan_nodes} (
            ...
            resolved_drive_folder_id VARCHAR(191) NULL,
