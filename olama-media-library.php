...
define('OLAMA_MEDIA_LIBRARY_VERSION', '2.11.0');
define('OLAMA_MEDIA_LIBRARY_DB_VERSION', '2.9.0');
...
// Server-side rollout gates. Uploads now use the reviewed, read-only folder
// resolver; legacy sync and general-purpose folder creation stay frozen.
if (!defined('OLAMA_MEDIA_DRIVE_UPLOAD_ENABLED')) {
    define('OLAMA_MEDIA_DRIVE_UPLOAD_ENABLED', true);
}
...
require_once OLAMA_MEDIA_LIBRARY_PATH . 'includes/class-olama-media-safe-upload-folder-resolver.php';
...
require_once OLAMA_MEDIA_LIBRARY_PATH . 'includes/class-olama-media-rollout-readiness.php';
